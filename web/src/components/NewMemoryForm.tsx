...
export function NewMemoryForm() {
    ...
    async function handleCreateMemory(event: FormEvent<HTMLFormElement>) {
        event.preventDefault() //evita o form ficar redirecionando dps do submit
        ...
        if (fileToUpload) {
            //Essa rota so suporta o tipo form-data, nao json. Por isso tem ate o fastify/multipart lá.
    ...
    return (
        ...
        >
            <div className="flex items-center gap-4">
                ...
                edit: agr está dentro do MediaPicker pra usar o 'use client' 
                */}
